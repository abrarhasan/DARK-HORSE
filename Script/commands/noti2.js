...
module.exports.handleReply = async function ({
 ...
 case "reply":
 {
 let _0x1d62c6 = "𝐀𝐃𝐌𝐈𝐍 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐓𝐈𝐎𝐍\n•┄┅═════❁🌺❁═════┅┄•\n\n｢𝐌𝐄𝐒𝐒𝐀𝐆𝐄｣ : " + _0x32e73c + "\n\n\n｢𝗔𝗗𝗠𝗜𝗡 ｣ " + _0x509b63 + "\n\n•┄┅═════❁🌺❁═════┅┄• If you want to talk to the admin, then you must reply to this message. I will forward it to the admin.";
 if (_0x218c1b.attachments.length > 0) {
 _0x1d62c6 = await getAtm(_0x218c1b.attachments, _0x32e73c + " 𝐀𝐃𝐌𝐈𝐍 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐓𝐈𝐎𝐍 \n•┄┅═════❁🌺❁═════┅┄•\n\n 𝐀𝐃𝐌𝐈𝐍 " + _0x509b63 + "\n\n•┄┅═════❁🌺❁═════┅┄•If you want to talk to the admin, then you must reply to the message. I will forward it to the admin.");
 }
